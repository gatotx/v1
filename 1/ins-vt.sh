...
# install v2ray
wget https://raw.githubusercontent.com/gatotx/v1/main/1/go.sh && chmod +x go.sh && ./go.sh
rm -f /root/go.sh
...
cd /usr/bin
wget -O certv2ray "https://raw.githubusercontent.com/gatotx/v1/main/1/cert.sh"
chmod +x certv2ray
cd
rm -f ins-vt.sh
