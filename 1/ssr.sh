...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/gatotx/v1/main/1/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://raw.githubusercontent.com/gatotx/v1/main/1/ssrmu.sh && chmod +x /usr/bin/ssr
